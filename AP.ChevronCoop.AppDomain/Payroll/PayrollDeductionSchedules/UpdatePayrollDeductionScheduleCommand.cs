...
namespace AP.ChevronCoop.AppDomain.Payroll.PayrollDeductionSchedule;

public class UpdatePayrollDeductionScheduleCommand : UpdateCommand,
  IRequest<CommandResult<PayrollDeductionScheduleViewModel>>
{
    [MaxLength(512)]
    [Required]
