...
public class DeleteCustomerNextOfKinCommandValidator : AbstractValidator<DeleteCustomerNextOfKinCommand>
{

    private readonly ChevronCoopDbContext dbContext;
    private readonly ILogger<DeleteCustomerNextOfKinCommandValidator> logger;
    public DeleteCustomerNextOfKinCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteCustomerNextOfKinCommandValidator> _logger)
    {
