...
{
    public partial class DeletePayrollCronJobConfigCommandValidator : AbstractValidator<DeletePayrollCronJobConfigCommand>
    {

        private readonly ChevronCoopDbContext dbContext;
        private readonly ILogger<DeletePayrollCronJobConfigCommandValidator> logger;
        public DeletePayrollCronJobConfigCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeletePayrollCronJobConfigCommandValidator> _logger)
        {
