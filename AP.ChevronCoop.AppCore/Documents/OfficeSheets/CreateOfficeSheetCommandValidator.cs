...
public partial class CreateOfficeSheetCommandValidator : AbstractValidator<CreateOfficeSheetCommand>
{

    private readonly ChevronCoopDbContext dbContext;
    private readonly ILogger<CreateOfficeSheetCommandValidator> logger;
    public CreateOfficeSheetCommandValidator(ChevronCoopDbContext appDbContext, ILogger<CreateOfficeSheetCommandValidator> _logger)
    {
