...
public partial class UpdateOfficeSheetCommandValidator : AbstractValidator<UpdateOfficeSheetCommand>
{

    private readonly ChevronCoopDbContext dbContext;
    private readonly ILogger<UpdateOfficeSheetCommandValidator> logger;
    public UpdateOfficeSheetCommandValidator(ChevronCoopDbContext appDbContext, ILogger<UpdateOfficeSheetCommandValidator> _logger)
    {
