...
{
    public partial class DeleteDepositProductInterestRangeCommandValidator : AbstractValidator<DeleteDepositProductInterestRangeCommand>
    {

        private readonly ChevronCoopDbContext dbContext;
        private readonly ILogger<DeleteDepositProductInterestRangeCommandValidator> logger;
        public DeleteDepositProductInterestRangeCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteDepositProductInterestRangeCommandValidator> _logger)
        {
