...
public partial class DeleteFixedDepositChangeInMaturityCommandValidator : AbstractValidator<DeleteFixedDepositChangeInMaturityCommand>
{

    private readonly ChevronCoopDbContext dbContext;
    private readonly ILogger<DeleteFixedDepositChangeInMaturityCommandValidator> logger;
    public DeleteFixedDepositChangeInMaturityCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteFixedDepositChangeInMaturityCommandValidator> _logger)
    {
