...
{
    public partial class DeleteSpecialDepositInterestScheduleCommandValidator : AbstractValidator<DeleteSpecialDepositInterestScheduleCommand>
    {

        private readonly ChevronCoopDbContext dbContext;
        private readonly ILogger<DeleteSpecialDepositInterestScheduleCommandValidator> logger;
        public DeleteSpecialDepositInterestScheduleCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteSpecialDepositInterestScheduleCommandValidator> _logger)
        {
