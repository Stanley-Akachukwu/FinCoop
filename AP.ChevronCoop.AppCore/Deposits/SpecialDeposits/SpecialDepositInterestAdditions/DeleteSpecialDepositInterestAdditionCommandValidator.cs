...
{
    public partial class DeleteSpecialDepositInterestAdditionCommandValidator : AbstractValidator<DeleteSpecialDepositInterestAdditionCommand>
    {

        private readonly ChevronCoopDbContext dbContext;
        private readonly ILogger<DeleteSpecialDepositInterestAdditionCommandValidator> logger;
        public DeleteSpecialDepositInterestAdditionCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteSpecialDepositInterestAdditionCommandValidator> _logger)
        {
