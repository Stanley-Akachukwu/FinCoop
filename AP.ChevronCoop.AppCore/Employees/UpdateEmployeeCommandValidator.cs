...
public partial class UpdateEmployeeCommandValidator : AbstractValidator<UpdateEmployeeCommand>
{
    ...
    private readonly ILogger<UpdateEmployeeCommandValidator> logger;
    public UpdateEmployeeCommandValidator(ChevronCoopDbContext appDbContext, ILogger<UpdateEmployeeCommandValidator> _logger)
    {
        ...
        RuleFor(p => p).Custom((data, context) =>
        {
            ...
            var checkId = dbContext.Employees.Where(r => r.Id == data.Id).Any();
            if (!checkId)
            {
                context.AddFailure(
            ...
            /*
                    ...
                    var checkName = dbContext.Employees.Where(r => r.Id != data.Id &&
                    ...
                    var checkCode = dbContext.Employees.Where(r => r.Id != data.Id &&
