...
public class DeleteLoanAccountCommandValidator : AbstractValidator<DeleteLoanAccountCommand>
{
  private readonly ChevronCoopDbContext dbContext;
  private readonly ILogger<DeleteLoanAccountCommandValidator> logger;

  public DeleteLoanAccountCommandValidator(ChevronCoopDbContext appDbContext,
    ILogger<DeleteLoanAccountCommandValidator> _logger)
  {
