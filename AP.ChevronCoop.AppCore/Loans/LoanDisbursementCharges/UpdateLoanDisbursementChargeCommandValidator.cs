...
{
    public partial class UpdateLoanDisbursementChargeCommandValidator : AbstractValidator<UpdateLoanDisbursementChargeCommand>
    {

  private readonly ChevronCoopDbContext dbContext;
  private readonly ILogger<UpdateLoanDisbursementChargeCommandValidator> logger;
        public UpdateLoanDisbursementChargeCommandValidator(ChevronCoopDbContext appDbContext, ILogger<UpdateLoanDisbursementChargeCommandValidator> _logger)
  {
    ...
    RuleFor(p => p).Custom((data, context) =>
    {
      ...
      var checkName = dbContext.LoanDisbursementCharges.Where(r => r.Id != data.Id &&
      ...
      var checkCode = dbContext.LoanDisbursementCharges.Where(r => r.Id != data.Id &&
