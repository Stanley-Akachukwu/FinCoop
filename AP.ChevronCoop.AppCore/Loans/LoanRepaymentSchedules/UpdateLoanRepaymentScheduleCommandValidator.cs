...
public class UpdateLoanRepaymentScheduleCommandValidator : AbstractValidator<UpdateLoanRepaymentScheduleCommand>
{
  private readonly ChevronCoopDbContext dbContext;
  private readonly ILogger<UpdateLoanRepaymentScheduleCommandValidator> logger;

  public UpdateLoanRepaymentScheduleCommandValidator(ChevronCoopDbContext appDbContext,
    ILogger<UpdateLoanRepaymentScheduleCommandValidator> _logger)
  {
    ...
    {
      // var checkId = dbContext.LoanRepaymentSchedules.Where(r => r.Id == data.Id).Any();
      // if (!checkId)
      //     context.AddFailure(
      ...
      /*
              ...
              var checkName = dbContext.LoanRepaymentSchedules.Where(r => r.Id != data.Id &&
              ...
              var checkCode = dbContext.LoanRepaymentSchedules.Where(r => r.Id != data.Id &&
