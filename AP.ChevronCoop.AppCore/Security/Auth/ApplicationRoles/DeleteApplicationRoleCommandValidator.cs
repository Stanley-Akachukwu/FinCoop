...
{
    public partial class DeleteApplicationRoleCommandValidator : AbstractValidator<DeleteApplicationRoleCommand>
    {

        private readonly ChevronCoopDbContext dbContext;
        private readonly ILogger<DeleteApplicationRoleCommandValidator> logger;
        public DeleteApplicationRoleCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteApplicationRoleCommandValidator> _logger)
        {
