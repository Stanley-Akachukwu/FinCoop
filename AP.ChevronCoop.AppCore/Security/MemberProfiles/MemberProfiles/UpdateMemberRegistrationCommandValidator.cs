...
public class UpdateMemberRegistrationCommandValidator : AbstractValidator<UpdateMemberRegistrationCommand>
{

    private readonly ChevronCoopDbContext dbContext;
    private readonly ILogger<UpdateMemberRegistrationCommandValidator> logger;

    public UpdateMemberRegistrationCommandValidator(ChevronCoopDbContext appDbContext,
        ILogger<UpdateMemberRegistrationCommandValidator> _logger)
    {
