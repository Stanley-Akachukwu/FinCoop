...
{
    public partial class DeleteApprovalCommandValidator : AbstractValidator<DeleteApprovalCommand>
    {

        private readonly ChevronCoopDbContext dbContext;
        private readonly ILogger<DeleteApprovalCommandValidator> logger;
        public DeleteApprovalCommandValidator(ChevronCoopDbContext appDbContext, ILogger<DeleteApprovalCommandValidator> _logger)
        {
