...
public class LoanDisbursementApprovalFactory : IApprovalFactory
{
    private readonly ChevronCoopDbContext _dbContext;
    private readonly IMapper _mapper;
    private readonly IMediator _mediator;

    public LoanDisbursementApprovalFactory(ChevronCoopDbContext dbContext, IMapper mapper, IMediator mediator)
    {
      ...
      ApprovalStatus status)
    {
        ...
        if (disbursement != null)
        {
            ...
            var transaction = new LoanTransactionCommand()
            {
                ...
                TransactionType = TransactionType.LOAN_DISBURSEMENT_FULL,
