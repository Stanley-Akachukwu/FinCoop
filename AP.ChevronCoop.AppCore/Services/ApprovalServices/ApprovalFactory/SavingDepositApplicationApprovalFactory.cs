...
public class SavingDepositApplicationApprovalFactory : IApprovalFactory
{
    private readonly ChevronCoopDbContext _dbContext;
    private readonly IMapper _mapper;
    private readonly IMediator _mediator;

    public SavingDepositApplicationApprovalFactory(ChevronCoopDbContext dbContext, IMapper mapper, IMediator mediator)
    {
    ...
    public async Task<CommandResult<bool>> Process(Approval request, string? approvedById, string? comment, ApprovalStatus status)
    {
        ...
        try
        {
            ...
            var application = _dbContext.SavingsAccountApplications.FirstOrDefault(x => x.Id == request.EntityId);
            ...
            if (application != null)
            {
                var command = new CreateSavingsAccountCommand
                {
                    ...
                    PayrollAmount = application.Amount,
