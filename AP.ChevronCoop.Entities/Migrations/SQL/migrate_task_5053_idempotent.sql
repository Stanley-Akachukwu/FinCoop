...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_AccountingPeriod_Name] ON [Accounting].[AccountingPeriod] ([Name]) WHERE [Name] IS NOT NULL');
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [RoleNameIndex] ON [Security].[ApplicationRole] ([NormalizedName]) WHERE [NormalizedName] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [UserNameIndex] ON [Security].[ApplicationUser] ([NormalizedUserName]) WHERE [NormalizedUserName] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Customer_ApplicationUserId] ON [Customer].[Customer] ([ApplicationUserId]) WHERE [ApplicationUserId] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Permission_Name_Code_Category] ON [Security].[Permission] ([Name], [Code], [Category]) WHERE [Name] IS NOT NULL AND [Code] IS NOT NULL AND [Category] IS NOT NULL');
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Permission_Name_Code_Group] ON [Security].[Permission] ([Name], [Code], [Group]) WHERE [Name] IS NOT NULL AND [Code] IS NOT NULL AND [Group] IS NOT NULL');
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Permission_Name_Code_Module] ON [Security].[Permission] ([Name], [Code], [Module]) WHERE [Name] IS NOT NULL AND [Code] IS NOT NULL AND [Module] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_SavingsCashAddition_BatchRefNo] ON [Deposits].[SavingsCashAddition] ([BatchRefNo]) WHERE [BatchRefNo] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_SpecialDepositAccount_AccountNo] ON [Deposits].[SpecialDepositAccount] ([AccountNo]) WHERE [AccountNo] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_SpecialDepositAccountApplication_ApplicationNo] ON [Deposits].[SpecialDepositAccountApplication] ([ApplicationNo]) WHERE [ApplicationNo] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710041216_migrate_task_3856')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_SpecialDepositCashAddition_BatchRefNo] ON [Deposits].[SpecialDepositCashAddition] ([BatchRefNo]) WHERE [BatchRefNo] IS NOT NULL');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230710081636_migrate_task_3874')
BEGIN
...
BEGIN
    ...
    EXEC(N'UPDATE [Customer].[CustomerBankAccount] SET [LedgerAccountId] = N'''' WHERE [LedgerAccountId] IS NULL');
...
BEGIN
    ...
    EXEC(N'UPDATE [Customer].[CustomerBankAccount] SET [CustomerId] = N'''' WHERE [CustomerId] IS NULL');
...
BEGIN
    ...
    EXEC(N'UPDATE [Customer].[CustomerBankAccount] SET [BankId] = N'''' WHERE [BankId] IS NULL');
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230714125803_migrate_task_3936')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230716010715_migrate_task_3965')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230717072441_migrate_task_3980')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230717085401_migrate_task_3988')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230717230410_migrate_task_4034')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230724103941_migrate_task_4196')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230724105953_migrate_task_4201')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230725011419_migrate_task_4230')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230725113915_migrate_task_4259')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230726230014_migrate_task_4288')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230727182950_migrate_task_4300')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230729153225_migrate_task_4338')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230730045507_migrate_task_4413')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230730123618_migrate_task_4465')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230731000801_migrate_task_4494')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230731022801_migrate_task_4503')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230801090428_migrate_task_4534')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230801103640_migrate_task_4547')
BEGIN
...
BEGIN
    ...
    EXEC(N'UPDATE [Loans].[LoanAccount] SET [LoanTopupId] = N'''' WHERE [LoanTopupId] IS NULL');
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230801111245_migrate_task_4557')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230801120146_migrate_task_4568')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230801170407_migrate_task_4587')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] DROP CONSTRAINT [FK_LoanAccount_LoanTopup_LoanTopupId];
END;
GO
...
BEGIN
    ...
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Security].[MemberBulkUploadTemp]') AND [c].[name] = N'MemberType');
    IF @var17 IS NOT NULL EXEC(N'ALTER TABLE [Security].[MemberBulkUploadTemp] DROP CONSTRAINT [' + @var17 + '];');
    ALTER TABLE [Security].[MemberBulkUploadTemp] ALTER COLUMN [MemberType] nvarchar(max) NULL;
END;
GO
...
BEGIN
    ...
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Loans].[LoanAccount]') AND [c].[name] = N'LoanTopupId');
    IF @var18 IS NOT NULL EXEC(N'ALTER TABLE [Loans].[LoanAccount] DROP CONSTRAINT [' + @var18 + '];');
    ALTER TABLE [Loans].[LoanAccount] ALTER COLUMN [LoanTopupId] nvarchar(40) NULL;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230801170407_migrate_task_4587')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] ADD CONSTRAINT [FK_LoanAccount_LoanTopup_LoanTopupId] FOREIGN KEY ([LoanTopupId]) REFERENCES [Loans].[LoanTopup] ([Id]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230801170407_migrate_task_4587', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230802190720_migrate_task_4629')
BEGIN
    ALTER TABLE [Loans].[LoanRepaymentSchedule] ADD [ActualInterestAllocated] decimal(18,2) NOT NULL DEFAULT 0.0;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230802190720_migrate_task_4629')
BEGIN
    ALTER TABLE [Loans].[LoanRepaymentSchedule] ADD [ActualInterestBalance] decimal(18,2) NOT NULL DEFAULT 0.0;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230802190720_migrate_task_4629')
BEGIN
    ALTER TABLE [Loans].[LoanRepaymentSchedule] ADD [ActualPrincipalAllocated] decimal(18,2) NOT NULL DEFAULT 0.0;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230802190720_migrate_task_4629')
BEGIN
    ALTER TABLE [Loans].[LoanRepaymentSchedule] ADD [ActualPrincipalBalance] decimal(18,2) NOT NULL DEFAULT 0.0;
END;
GO
...
BEGIN
    ...
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Deposits].[DepositProductCharge]') AND [c].[name] = N'ChargeType');
    IF @var19 IS NOT NULL EXEC(N'ALTER TABLE [Deposits].[DepositProductCharge] DROP CONSTRAINT [' + @var19 + '];');
    ALTER TABLE [Deposits].[DepositProductCharge] ALTER COLUMN [ChargeType] nvarchar(128) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230802190720_migrate_task_4629', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] ADD [LoanCreationType] nvarchar(100) NOT NULL DEFAULT N'';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] ADD [ParentAccountId] nvarchar(40) NULL;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] ADD [RootParentAccountId] nvarchar(40) NULL;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    CREATE INDEX [IX_LoanAccount_ParentAccountId] ON [Loans].[LoanAccount] ([ParentAccountId]);
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    CREATE INDEX [IX_LoanAccount_RootParentAccountId] ON [Loans].[LoanAccount] ([RootParentAccountId]);
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] ADD CONSTRAINT [FK_LoanAccount_LoanAccount_ParentAccountId] FOREIGN KEY ([ParentAccountId]) REFERENCES [Loans].[LoanAccount] ([Id]);
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230804124111_migrate_task_4867')
BEGIN
    ALTER TABLE [Loans].[LoanAccount] ADD CONSTRAINT [FK_LoanAccount_LoanAccount_RootParentAccountId] FOREIGN KEY ([RootParentAccountId]) REFERENCES [Loans].[LoanAccount] ([Id]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230804124111_migrate_task_4867', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230805050331_migrate_task_4883')
BEGIN
    DECLARE @var20 sysname;
    SELECT @var20 = [d].[name]
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Docs].[CustomerPaymentDocument]') AND [c].[name] = N'FileName');
    IF @var20 IS NOT NULL EXEC(N'ALTER TABLE [Docs].[CustomerPaymentDocument] DROP CONSTRAINT [' + @var20 + '];');
    ALTER TABLE [Docs].[CustomerPaymentDocument] ALTER COLUMN [FileName] nvarchar(max) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230805050331_migrate_task_4883', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230805081958_migrate_task_4886')
BEGIN
    ALTER TABLE [Security].[ApprovalGroupMember] DROP CONSTRAINT [FK_ApprovalGroupMember_ApprovalGroup_ApprovalGroupId1];
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230805081958_migrate_task_4886')
BEGIN
    DROP INDEX [IX_ApprovalGroupMember_ApprovalGroupId1] ON [Security].[ApprovalGroupMember];
END;
GO
...
BEGIN
    ...
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Security].[ApprovalGroupMember]') AND [c].[name] = N'ApprovalGroupId1');
    IF @var21 IS NOT NULL EXEC(N'ALTER TABLE [Security].[ApprovalGroupMember] DROP CONSTRAINT [' + @var21 + '];');
    ALTER TABLE [Security].[ApprovalGroupMember] DROP COLUMN [ApprovalGroupId1];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230805081958_migrate_task_4886', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230805084450_migrate_task_4898')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230805084450_migrate_task_4898', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230808102718_migrate_task_4980')
BEGIN
    ALTER TABLE [Payroll].[PayrollDeductionScheduleItem] ADD [OriginalAmount] decimal(18,2) NOT NULL DEFAULT 0.0;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230808102718_migrate_task_4980', N'7.0.8');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230808222429_migrate_task_5053')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230808222429_migrate_task_5053', N'7.0.8');
END;
GO
