...
namespace ChevronCoop.Web.AppUI.BlazorServer.Areas.Identity.Pages.Account
{
    ...
    public class SwitchAccountModel : PageModel
    {
        ...
        public SwitchAccountModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, IEntityDataService entityDataService, IUtilityService utilityService)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string returnUrl = null)
        {
            ...
            SwitchToCorporate = SwhitchToCorporateMember();
            ...
            SwitchAccountCommand Model = new SwitchAccountCommand()
            {
                ...
                SwitchToCorporate = SwitchToCorporate
            };
...
new ClaimsPrincipal(claimsIdentity), authProperties);
        ...
        private bool SwhitchToCorporateMember()
        {
            var switchUrl = User.FindFirstValue(ClaimTypes.Uri);
            if (!string.IsNullOrEmpty(switchUrl) && switchUrl.ToLower() == "/dashboard")
                return true;
            return false;
        }
    }
