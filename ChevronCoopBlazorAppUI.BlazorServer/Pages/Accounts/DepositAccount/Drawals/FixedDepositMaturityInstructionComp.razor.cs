...
{
    public partial class FixedDepositMaturityInstructionComp
    {
        ...
        public CreateFixedDepositChangeInMaturityCommand Command { get; set; }
        ...
        {
            Command = new CreateFixedDepositChangeInMaturityCommand();
        ...
        public async Task GetFixedDepositMaturityInstructions()
        {
            ...
            if (rsp.IsSuccessStatusCode)
            {
                ...
                Command.MaturityInstructionType = maturityInstruction switch
                {
                    nameof(MaturityInstructionType.ROLLOVER_PRINCIPAL_AND_INTEREST) => MaturityInstructionType.ROLLOVER_PRINCIPAL_AND_INTEREST,
                    nameof(MaturityInstructionType.ROLLOVER_PRINCIPAL_AND_LIQUIDATE_INTEREST) => MaturityInstructionType.ROLLOVER_PRINCIPAL_AND_LIQUIDATE_INTEREST,
                    nameof(MaturityInstructionType.LIQUIDATE_PRINCIPAL_AND_INTEREST) => MaturityInstructionType.LIQUIDATE_PRINCIPAL_AND_INTEREST,
        ...
        public void MapToCommand()
        {
            ...
            //Command.Description =$"({FixedDepositAccountNumber}) Fixed deposit account was liquidated by {MembersName}";
        ...
        private async Task OnSave()
        {
            ...
            {
                Title = "Are you sure?",
                Text = $"You want to change the Maturity Instruction to {Command.MaturityInstructionType.ToString().Replace("_", " ")}?",
            ...
            if (!string.IsNullOrEmpty(result.Value))
            {
                ...
                //  if (await _fluentValidationValidator.ValidateAsync())
                {
                    var rsp = await DataService
                        .Create<CreateFixedDepositChangeInMaturityCommand, CommandResult<FixedDepositChangeInMaturityViewModel>>(
                            nameof(FixedDepositChangeInMaturity), Command);
