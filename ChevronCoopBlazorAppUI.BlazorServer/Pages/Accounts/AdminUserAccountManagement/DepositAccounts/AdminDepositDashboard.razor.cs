...
{
    public partial class AdminDepositDashboard
    {
        [Inject]
        ...
        {
            DepositAccountsMasterViewSrc = await customersMasterViews.GetAllDepositAccountMasterView();
           
            if (DepositAccountsMasterViewSrc.Count > 0)
            {
                ActivateTab();
                All = Active;
            }
            ...
            //        Description = MessageBox.NoRecordFoundMsg,
