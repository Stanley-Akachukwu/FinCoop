...
{
    public partial class JournalEntryEditForm
    {
        public JournalEntryEditForm()
        {
        }
        ...
        [Parameter]
        public UpdateJournalEntryCommand Model { get; set; }


        [Parameter]
        public EventCallback<UpdateJournalEntryCommand> ModelChanged { get; set; }
        ...
        [Inject]
        ILogger<JournalEntryEditForm> Logger { get; set; }
        ...
        {
            var rsp = await DataService.Update<UpdateJournalEntryCommand, CommandResult<JournalEntryViewModel>>(
        ...
        public async Task OnCancel()
        {
            ...
            Model = new UpdateJournalEntryCommand();
