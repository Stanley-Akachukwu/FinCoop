...
{
    public partial class CompanyBankAccountEditForm
    {
        ...
        [Parameter]
        public UpdateCompanyBankAccountCommand Model { get; set; }


        [Parameter]
        public CompanyBankAccountMasterView MasterView { get; set; }

        [Parameter]
        public EventCallback<CompanyBankAccountMasterView> MasterViewChanged { get; set; }


        [Parameter]
        public EventCallback<UpdateCompanyBankAccountCommand> ModelChanged { get; set; }
        ...
        [Inject]
        ILogger<CompanyBankAccountEditForm> Logger { get; set; }
        ...
        public async Task OnSave()
        {
            var rsp = await DataService
                .Update<UpdateCompanyBankAccountCommand, CommandResult<CompanyBankAccountViewModel>>(
        ...
        public async Task OnCancel()
        {
            ...
            Model = new UpdateCompanyBankAccountCommand();
