...
{
    public partial class TransactionJournalEditForm
    {
        public TransactionJournalEditForm()
        {
        }
        ...
        [Parameter]
        public UpdateTransactionJournalCommand Model { get; set; }


        [Parameter]
        public EventCallback<UpdateTransactionJournalCommand> ModelChanged { get; set; }
        ...
        [Inject]
        ILogger<TransactionJournalEditForm> Logger { get; set; }
        ...
        public async Task OnSave()
        {
            var rsp = await DataService
                .Update<UpdateTransactionJournalCommand, CommandResult<TransactionJournalViewModel>>(
        ...
        public async Task OnCancel()
        {
            ...
            Model = new UpdateTransactionJournalCommand();
