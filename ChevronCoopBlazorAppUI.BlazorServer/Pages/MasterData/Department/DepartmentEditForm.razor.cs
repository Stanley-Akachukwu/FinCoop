...
namespace ChevronCoop.Web.AppUI.BlazorServer.Pages.MasterData.Department
{
    public partial class DepartmentEditForm
    {
        ...
        [Parameter]
        public UpdateDepartmentCommand Model { get; set; }


        [Parameter]
        public EventCallback<UpdateDepartmentCommand> ModelChanged { get; set; }
        ...
        [Inject]
        ILogger<DepartmentEditForm> Logger { get; set; }
        ...
        {
            var rsp = await DataService.Update<UpdateDepartmentCommand, CommandResult<DepartmentViewModel>>(
